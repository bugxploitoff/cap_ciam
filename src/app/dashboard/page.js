...
const Page = () => {
  ...
  useEffect(() => {
    ...
    if (!sessionCookie) {
      ...
      fetch('http://ec2-3-17-74-205.us-east-2.compute.amazonaws.com:5000/verify', {
        method: 'POST',
        headers: {
          ...
          >
            <div className="flex items-center justify-between gap-16">
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h1 className="font-normal text-[#060607] dark:text-white">Manage Containers</h1>
                </div>
              </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
          ...
          <div
            className="cursor-pointer select-none space-y-2 rounded-sm bg-[#f2f3f5] p-4 dark:bg-[#2b2d31] shadow-xl"
            onClick={() => handleFoodClick('incapi')}
          >
            <div className="flex items-center justify-between gap-16">
              <div className="flex items-center gap-4">
                <img
                ...
                />
                <div>
                  <h1 className="font-normal text-[#060607] dark:text-white">Incoming reguest</h1>
                </div>
              </div>
            <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
